...
class UserController extends Controller
{
     ...
     * @bodyParam activity_area string option update user name of auth user. Example: hanoi
     * @bodyParam brand_name string option update user name of auth user. Example: vingroup
    ...
    public function updateUserInfo(Request $request)
    {
        ...
        if (isset($request['activity_area'])) {
            $user['activity_area'] = $request['activity_area'];
        }
